...
class AboutClassMethods < Neo::Koan
  ...
  #   end
  #
  # Which do you prefer and why? the first
  # Are there times you might prefer one over the other? possibly but right now I don't see the upside of using the second method since it's more verbose
